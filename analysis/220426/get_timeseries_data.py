...
class DownloadData(IAnalyzer):
    ...
    def filter(self, simulation):
        if int(simulation.tags["scenario_number"]) in [13,19,22,30]:
            return True
        else:
            return False
...
if __name__ == "__main__":
    experiment_id = "7dfbe25b-29c0-ec11-a9f6-9440c9be2c51"
    # experiment_id = "5d3e97d2-2bc0-ec11-a9f6-9440c9be2c51"
